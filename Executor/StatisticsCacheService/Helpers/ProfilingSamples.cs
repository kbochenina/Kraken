...
namespace StatisticsCacheService.Helpers
{
    //todo: remove duplicates in StatProfiling project
    public static class ProfilingSamples
    {
        ...
        private static List<NodeInfo> createNodeInfos(Tuple<int/*min*/, int/*max*/> countInterval,
        ...
        private static Dictionary<string, List<NodeInfo>> createResource(int nodeCount, string baseName, Tuple<int/*min*/, int/*max*/> countInterval, Tuple<DateTime/*older*/, DateTime/*newer*/> timeInterval)
        {
        ...
        private static Dictionary<string, Dictionary<string, List<NodeInfo>>> createFarm(int resCount, string resBaseName, string nodeBaseName,
        ...
        public static Dictionary<string, Dictionary<string, List<NodeInfo>>> createHighLoadMockData()
        {
        ...
        public static Dictionary<string, Dictionary<string, List<NodeInfo>>> createMiddleSizeMockData()
        {
            return createFarm(80   , "resource", "node", new Tuple<int, int>(50, 50)/*50-100 and for using get.. and add.. simultaneously we get OutOfMemoryException*/,
               new Tuple<int, int>(20, 20),
               new Tuple<DateTime, DateTime>(new DateTime(2000, 1, 1, 1, 1, 1, 1), new DateTime(2013, 1, 1, 1, 1, 1, 1)));
        }

        public static Dictionary<string, Dictionary<string, List<NodeInfo>>> createMiniMockData()
        {
        ...
        private static void WriteToFile(string filename, Dictionary<string, Dictionary<string, List<NodeInfo>>> data)
        {
